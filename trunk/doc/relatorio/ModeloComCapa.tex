...
%\usepackage[dvips]{graphicx} % Importar figuras
...
\usepackage{amsfonts} % Fontes p/ conjuntos: R,Z,H,...
\usepackage{amssymb}
\usepackage{theorem}
\usepackage{latexsym}
\usepackage{amsxtra}
...
\bibitem{Tanen} A. S. Tanenbaum, {\it Operating Systems: Design and Implementation, Prentice Hall, Upper Saddle River, NJ, preprint (2008)}.

\bibitem \emph{Android Training}, disponível em 
\url{http://developer.android.com/training/index.html}.

\bibitem{Dawes, Abrahams} Beman Dawes, David Abrahams, \emph{Documentation},  preprint (2010), diponível em 
...
\bibitem{Arora} Himanshu Arora\emph{C Socket Programming for Linux with a Server and Client Example Code}{, preprint (2011)} , disponível em 
\url{http://www.thegeekstuff.com/2011/12/c-socket-programming/}.

\bibitem{Adiga} Harsha S. Adiga\emph{Writing endian-independent code in C}{IBM, Software Group, preprint (2007)} , disponível em 
