...
${OBJECTDIR}/src/cppMainServer.o: src/cppMainServer.cpp 
	...
	${RM} $@.d
	$(COMPILE.cc) -O2 -MMD -MP -MF $@.d -o ${OBJECTDIR}/src/cppMainServer.o src/cppMainServer.cpp

${OBJECTDIR}/src/ClientCpp.o: src/ClientCpp.cpp 
	${MKDIR} -p ${OBJECTDIR}/src
	${RM} $@.d
	$(COMPILE.cc) -O2 -MMD -MP -MF $@.d -o ${OBJECTDIR}/src/ClientCpp.o src/ClientCpp.cpp

${OBJECTDIR}/src/cppMainClient.o: src/cppMainClient.cpp 
	${MKDIR} -p ${OBJECTDIR}/src
	${RM} $@.d
	$(COMPILE.cc) -O2 -MMD -MP -MF $@.d -o ${OBJECTDIR}/src/cppMainClient.o src/cppMainClient.cpp

${OBJECTDIR}/src/cppMainInter.o: src/cppMainInter.cpp 
	${MKDIR} -p ${OBJECTDIR}/src
	${RM} $@.d
	$(COMPILE.cc) -O2 -MMD -MP -MF $@.d -o ${OBJECTDIR}/src/cppMainInter.o src/cppMainInter.cpp

${OBJECTDIR}/src/ServerCpp.o: src/ServerCpp.cpp 
	${MKDIR} -p ${OBJECTDIR}/src
	${RM} $@.d
	$(COMPILE.cc) -O2 -MMD -MP -MF $@.d -o ${OBJECTDIR}/src/ServerCpp.o src/ServerCpp.cpp

${OBJECTDIR}/src/ServerInterCpp.o: src/ServerInterCpp.cpp 
	${MKDIR} -p ${OBJECTDIR}/src
	${RM} $@.d
	$(COMPILE.cc) -O2 -MMD -MP -MF $@.d -o ${OBJECTDIR}/src/ServerInterCpp.o src/ServerInterCpp.cpp
